...
export function CreateNewModel({ handleModalCreateFilm, createFilm, isLoading }: CreateNewModelProps) {
  return (
    <div className="fixed inset-0 w-full h-full bg-black/60 flex items-center justify-center">
        <div className="bg-zinc-950 p-8 rounded-md md:w-[30rem] w-full relative">
          ...
          <button onClick={handleModalCreateFilm} className="text-zinc-100 absolute top-4 right-4">
